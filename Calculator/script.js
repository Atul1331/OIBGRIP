class Calc {
  ...
  // prettier-ignore
  const theme2 = ["#000", "rgb(25, 25, 25)" ,"rgb(25, 25, 25)",
  "rgb(10, 10, 10)", "hsl(281, 77%, 44%)", "hsl(285, 91%, 52%)", "hsl(176, 100%, 44%)",
  "hsl(176, 88%, 74%)", "hsl(177, 92%, 70%)", "rgb(15, 15, 15)", "hsl(268, 72%, 58%)",
